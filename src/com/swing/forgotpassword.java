...
public class forgotpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 230, 570, -1));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/swing/HOTEL.jpg"))); // NOI18N
        jLabel9.setText("jLabel9");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1450, 700));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
             ResultSet rs;
            rs = select.getData("select *from users where Email='"+Email+"' and security ='"+securityQuestion+"'and Answer='"+Answer+"'");
